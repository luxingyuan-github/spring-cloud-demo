...
public class MyBatisOrderConfig
{
    ...
    @Bean(name = "orderDataSource",destroyMethod = "close",initMethod = "init")
    ...
    public DataSourceProxy dataSourceProxy(@Qualifier("orderDataSource")DruidDataSource druidDataSource) {
    ...
    public SqlSessionFactory orderSqlSessionFactory(@Qualifier("orderDataSourceProxy") DataSourceProxy dataSourceProxy)
    {
